...
**WordCloud 1: Paper keywords** Wordcloud above has been generated based on gross keywords (as provided by PubMed) of all collected papers. Larger words were seen more frequently as paper keywords. 통계 1: (논문키워드) 위 그림은 확보한 논문들의 키워드들을 바탕으로 제작되었음.
...
- [**Papers published on high impact factor (IF>7) journal link (상위 인용지수 저널 논문 링크)**](./papers/topjpapers.md)
