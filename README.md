...
<p align="center">
    Quick links: [Notable papers(today)](./papers/topjpapers_today.md), [Abstracts(today)](./papers/todayabstract.md), [All papers](./papers/allpapers.md)
</p>
...
**WordCloud 1: Paper keywords** Wordcloud above has been generated based on gross keywords (as provided by PubMed) of all collected papers. Larger words were seen more frequently as paper keywords.<br /> 통계 1: (논문 키워드) 위 그림은 확보한 논문들의 키워드들을 바탕으로 제작되었음.
 <br />
 <br />
 <p align="center"><img width="95%" src="./logo/journal_wordcloud.png" /></p>

**WordCloud 2: Published Journals** It has been generated based on gross publications of each journal related to COVID-19. Journals with larger words have published more papers.<br /> 
...
## Significant result of the day <sub>오늘의 추천 논문</sub>
- will be updated

## Read today's abstracts <sub>오늘 게재된 논문의 초록 읽기</sub>
